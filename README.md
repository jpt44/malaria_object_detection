...
Dataset images are from: [Broad Bioimage Benchmark Collection](https://bbbc.broadinstitute.org/BBBC041)

Goal: identify types of malaira-infected cells that exist in an image

## Strategies:
1. (Multi-label Classification Only) Feed each image through a CNN and let it identify the type of infected cell(s) the image contains without finding its location in the image, i.e. no bounding boxes. 

2. (Object Detection) Feed each image through a CNN and let it identify the type of infected cell(s) the image contains and find it’s location, i.e. find bounding boxes
...
<caption>*Order of results: [Red blood cell, Leukocyte, Schizont:, Gametocyte, Ring, Trophozoite] using task-specific custom metrics</caption>
   ...
   <caption>*COCO 2017 Metrics</caption>
<br></br>
...
<p float="left">
  <img src="./malaria/inference/efficientdet_d2_coco17_tpu-32/0f26699f-a776-4424-b092-27da9a1d12e2.png" width="700" />
  <img src="./malaria/inference/efficientdet_d2_coco17_tpu-32/4a717a39-80f8-4b75-a25e-c46d65d7dcd5.png" width="700" /> 
</p>
...
<p float="left">
  <img src="./malaria/inference/ssd_mobilenet_v1_fpn_640x640_coco17_tpu-8/0f26699f-a776-4424-b092-27da9a1d12e2.png" width="700" />
  <img src="./malaria/inference/ssd_mobilenet_v1_fpn_640x640_coco17_tpu-8/4a717a39-80f8-4b75-a25e-c46d65d7dcd5.png" width="700" /> 
</p>
...
<p float="left">
  <img src="./malaria/inference/ssd_resnet50_v1_fpn_640x640_coco17_tpu-8/0f26699f-a776-4424-b092-27da9a1d12e2.png" width="700" />
  <img src="./malaria/inference/ssd_resnet50_v1_fpn_640x640_coco17_tpu-8/4a717a39-80f8-4b75-a25e-c46d65d7dcd5.png" width="700" /> 
</p>
